...
@Component({
  selector: "csr-connect-nav-bar-button",
  templateUrl: "./csr-connect-nav-bar-button.component.html",
  styleUrls: ["./csr-connect-nav-bar-button.component.scss"],
})
export class CsrConnectNavBarButtonComponent implements OnInit {
  @Input() label: string = "";
  @Input() icon: string = "";
  @Input() href: string = "";
